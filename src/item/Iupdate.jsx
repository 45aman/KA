...
const IUpdate =() => {
  return (
    ...
    <div className="container-fluid nav_bg">
            ...
            <h3><strong className="item"> UPDATE  </strong><FontAwesomeIcon icon={faWrench} className="icon"/></h3>
            <hr/>
                <div className=" ">
...
<hr/>
                ...
                <button type="button" className="btn btn-outline-secondary but-sm mr-3"> UPDATE</button>
